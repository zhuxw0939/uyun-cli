 ...
 * 接口数量 312
 * http://192.168.2.56:3300/api/list?p_id=SklRa0r$qg&v_id=SJxRNEcHqx
 *
 * 2017-05-04 14:25:35 (c) sxApi Foundation, Inc.
 *
 **/ 
 ...
 */
exports.findStudent = function (data, callback) {
	servers.GET({
		url: "/analysis/api/student/find_student/"+data.examId+"/"+data.studentId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.AnalysisCustomReportApi_findReports = function (data, callback) {
	servers.POST({
		url: "/analysis/api/report/find_reports",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.importTargetOss = function (data, callback) {
	servers.POST({
...
/** 
 * Created by AnalysisMobileSXTApi-findRankByExamId
 *
 ...
 */
exports.AnalysisMobileSXTApi_findRankByExamId = function (data, callback) {
	servers.GET({
		url: "/analysis/api/mobile/sxt/find_rank_by_exam_id",
		token: data.TOKEN!=undefined?data.TOKEN:"",
		swaggerId: "AnalysisMobileSXTApi-findRankByExamId",
		query: {
			examId: data.examId,
...
/** End AnalysisMobileSXTApi-findRankByExamId */
 ...
 */
exports.listCountyAndSchoolsPhase = function (data, callback) {
	servers.GET({
...
exports.departmentList = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-class-part/page",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.listCommonSubjects = function (data, callback) {
	servers.GET({
 ...
 */
exports.teacherFindClass = function (data, callback) {
	servers.GET({
 ...
 */
exports.getSettingPaperSplitList = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-paper-split/list/"+data.courseId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @param 	任课教师参数对象-Body
 */
exports.findAnalysisTeachers = function (data, callback) {
	servers.POST({
		url: "/analysis/api/teacher/find_analysis_teachers",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @param 	学生分析参数列表-Body
 */
exports.exportStudents = function (data, callback) {
	servers.POST({
		url: "/analysis/api/student/export_students",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.exportRegionExcellent = function (data, callback) {
	servers.POST({
		url: "/analysis/api/excellent/export_region_excellent",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamQuestionApi_tempSave = function (data, callback) {
	servers.POST({
		url: "/exam/api/question/temp_save/"+data.courseId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.firstWords = function (data, callback) {
	servers.GET({
 ...
 */
exports.getAnalysisClassScorePart = function (data, callback) {
	servers.POST({
		url: "/analysis/api/class/find_class_section",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.AnalysisExcellentApi_exportStudents = function (data, callback) {
	servers.POST({
		url: "/analysis/api/excellent/export_students",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @param 	学生分析参数列表-Body
 */
exports.getAnalysisStudentsList = function (data, callback) {
	servers.POST({
		url: "/analysis/api/student/find_students",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.findClassPoint = function (data, callback) {
	servers.POST({
		url: "/analysis/api/paper/find_class_point",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.findStudentRank = function (data, callback) {
	servers.GET({
		url: "/analysis/api/student/find_student_rank/"+data.schoolId+"/"+data.studentId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.findRegionAbility = function (data, callback) {
	servers.GET({
		url: "/analysis/api/region-paper/find_region_ability/"+data.examCourseId+"/"+data.regionId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.scoreImportDownloadTemplate = function (data, callback) {
	servers.GET({
 ...
 * @params 	参数-Body
 */
exports.findChoiceQuestion = function (data, callback) {
	servers.POST({
		url: "/analysis/api/paper/find_choice_question",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.exportRegionSplitPaper = function (data, callback) {
	servers.POST({
		url: "/analysis/api/region-paper/export_split_paper",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examId 	考试ID-String
 */
exports.scoreImportGetMarkStates = function (data, callback) {
	servers.GET({
...
exports.ExamIndexApi_hello_test = function (data, callback) {
	servers.GET({
		url: "/exam/api/index/hello/"+data.id,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.getAnalysisStudentTrendCompare  = function (data, callback) {
	servers.POST({
		url: "/analysis/api/student/find_student_class_exam_trend",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamScoreLineApi_importData = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-score-line/import_data",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
/** 
 * Created by AnalysisMobileTouchLineApi-findStudents_1
 *
 * 踩线生列表查询 #2017-03-10#
 *
 * @params 	查询参数-Body
 */
exports.AnalysisMobileTouchLineApi_findStudents_1 = function (data, callback) {
	servers.POST({
		url: "/analysis/api/touch-line/find_students",
		token: data.TOKEN!=undefined?data.TOKEN:"",
		swaggerId: "AnalysisMobileTouchLineApi-findStudents_1",
		body: data.body,
		query: {
		}
	}, callback);
};
/** End AnalysisMobileTouchLineApi-findStudents_1 */
 ...
 * @params 	参数-Body
 */
exports.exportRegionChoiceQuestion = function (data, callback) {
	servers.POST({
		url: "/analysis/api/region-paper/export_choice_question",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examId 	考试ID-String
 */
exports.queryUnpublish = function (data, callback) {
	servers.PUT({
...
exports.AnalysisStudentApi_findStudentGradeExamTrend = function (data, callback) {
	servers.POST({
		url: "/analysis/api/student/find_student_grade_exam_trend",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.getQuestionsNumByCourseId = function (data, callback) {
	servers.GET({
		url: "/exam/api/question/find_questions/"+data.courseId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.AnalysisExcellentApi_countStudents = function (data, callback) {
	servers.GET({
		url: "/analysis/api/excellent/count_students/"+data.schoolId+"/"+data.examId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.findClassTarget = function (data, callback) {
	servers.POST({
		url: "/analysis/api/target/find_class_targets",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.findRegionChoiceQuestion = function (data, callback) {
	servers.POST({
		url: "/analysis/api/region-paper/find_choice_question",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamScoreLineApi_validate = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-score-line/validate",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.getAnalysisBrotherSchoolAverage = function (data, callback) {
	servers.GET({
		url: "/analysis/api/brother-school/find_average/"+data.examId+"/"+data.schoolId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @param 	特优生列表参数列表对象-Body
 */
exports.findRegionExcellent = function (data, callback) {
	servers.POST({
		url: "/analysis/api/excellent/find_region_excellent",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.getCountOrgExamNumber = function (data, callback) {
	servers.GET({
		url: "/exam/api/index/count_org_level",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
/** 
 * Created by AnalysisMobileSXTApi-findTeacherScoreRemarkStudents
 *
 * 查询成绩点评需要的被点评的学生信息(刘世平) #2017-05-02#
 *
 * @param 	查询参数-Body
 */
exports.AnalysisMobileSXTApi_findTeacherScoreRemarkStudents = function (data, callback) {
	servers.POST({
		url: "/analysis/api/mobile/sxt/find_teacher_score_remark_students",
		token: data.TOKEN!=undefined?data.TOKEN:"",
		swaggerId: "AnalysisMobileSXTApi-findTeacherScoreRemarkStudents",
		body: data.body,
		query: {
		}
	}, callback);
};
/** End AnalysisMobileSXTApi-findTeacherScoreRemarkStudents */
 ...
 */
exports.consolidationList = function (data, callback) {
	servers.GET({
 ...
 */
exports.exportSectionSchool = function (data, callback) {
	servers.POST({
		url: "/analysis/api/school/export_section",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.AnalysisBrotherSchoolApi_exportScoreLine = function (data, callback) {
	servers.GET({
		url: "/analysis/api/brother-school/export_score_line/"+data.examId+"/"+data.schoolId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @param 	查询参数-Body
 */
exports.exportByRegion = function (data, callback) {
	servers.POST({
		url: "/analysis/api/touch-line/export_by_region",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
/** 
 * Created by AnalysisMobileSXTApi-findPaperQuestionRatio
 *
 * 查询一个学科所有试题的得分率（孟加鑫） #2017-05-02#
 *
 * @examId 	考试Id-String
 * @baseCourseId 	云平台科目Id-String
 */
exports.AnalysisMobileSXTApi_findPaperQuestionRatio = function (data, callback) {
	servers.GET({
		url: "/analysis/api/mobile/sxt/find_paper_question_ratio",
		token: data.TOKEN!=undefined?data.TOKEN:"",
		swaggerId: "AnalysisMobileSXTApi-findPaperQuestionRatio",
		query: {
			examId: data.examId,
...
/** End AnalysisMobileSXTApi-findPaperQuestionRatio */
 ...
 * @params 	参数-Body
 */
exports.exportClassTargets = function (data, callback) {
	servers.POST({
		url: "/analysis/api/target/export_class_targets",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.updateErrorData = function (data, callback) {
	servers.POST({
...
exports.AnalysisBrotherSchoolApi_exportExtendStudents = function (data, callback) {
	servers.POST({
		url: "/analysis/api/brother-school/export_valid_extend_students",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.schoolFindClass = function (data, callback) {
	servers.GET({
 ...
 */
exports.importStudentTicket = function (data, callback) {
	servers.POST({
...
/** 
 * Created by ExamQuestionApi-startEdit
 *
 * 开始编辑试题数据 (郑强) #2017-05-04#
 *
 * @courseId 	科目ID-String
 */
exports.ExamQuestionApi_startEdit = function (data, callback) {
	servers.POST({
		url: "/exam/api/question/start_edit/"+data.courseId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
		swaggerId: "ExamQuestionApi-startEdit",
		query: {
		}
	}, callback);
};
/** End ExamQuestionApi-startEdit */
...
exports.getSchoolYearExamCount = function (data, callback) {
	servers.GET({
		url: "/exam/api/index/count_school_year/"+data.start+"/"+data.end,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.exportClassPoint = function (data, callback) {
	servers.POST({
		url: "/analysis/api/paper/export_class_point",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @phase 	学段，为空时查询所有学段-Number
 */
exports.orgListSchools = function (data, callback) {
	servers.GET({
 ...
 */
exports.getBrotherSchoolList = function (data, callback) {
	servers.GET({
 ...
 */
exports.getAnalysisClassTrendCompare = function (data, callback) {
	servers.POST({
		url: "/analysis/api/class/find_class_exam_trend",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.AnalysisMobileTouchLineApi_exportStudents = function (data, callback) {
	servers.POST({
		url: "/analysis/api/touch-line/export_students",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.AnalysisClassApi_exportClassSection = function (data, callback) {
	servers.POST({
		url: "/analysis/api/class/export_class_section",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.countClassTarget = function (data, callback) {
	servers.POST({
		url: "/analysis/api/target/count_class_targets",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.exportClassSelectionQuestion = function (data, callback) {
	servers.GET({
		url: "/analysis/api/paper/export_selection_question/"+data.schoolId+"/"+data.examCourseId+"/"+data.classId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.getAnalysisClassAverage = function (data, callback) {
	servers.POST({
		url: "/analysis/api/class/find_class_average",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examId 	考试ID-String
 */
exports.deleteExam = function (data, callback) {
	servers.DELETE({
 ...
 * @examId 	考试ID-String * @schoolId 	本校ID-String * @artCategory 	文理科-Number
 */
exports.getAnalysisBrotherSchoolScoreLine = function (data, callback) {
	servers.GET({
		url: "/analysis/api/brother-school/find_score_line/"+data.examId+"/"+data.schoolId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examId 	考试ID-String * @schoolId 	本校ID-String * @artCategory 	文理科-Number
 */
exports.getAnalysisBrotherSchoolExtend = function (data, callback) {
	servers.GET({
		url: "/analysis/api/brother-school/find_extend_students/"+data.examId+"/"+data.schoolId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.AnalysisExcellentApi_saveExcellent = function (data, callback) {
	servers.POST({
		url: "/analysis/api/excellent/save_excellent",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 *
 */
exports.existByRegion = function (data, callback) {
	servers.GET({
 ...
 */
exports.getAnalysisStudentCompare = function (data, callback) {
	servers.POST({
		url: "/analysis/api/student/find_student_compare",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.findQuestionStatistical = function (data, callback) {
	servers.GET({
		url: "/analysis/api/region-paper/find_question_statistical/"+data.examId+"/"+data.regionId+"/"+data.questionId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamQuestionApi_export = function (data, callback) {
	servers.GET({
		url: "/exam/api/question/export/"+data.courseId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.exportConsolidation = function (data, callback) {
	servers.POST({
 ...
 * @param 	任课教师参数对象-Body
 */
exports.exportAnalysisTeachers = function (data, callback) {
	servers.POST({
		url: "/analysis/api/teacher/export_analysis_teachers",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @param 	优生统计参数列表-Body
 */
exports.exportProminentSchool = function (data, callback) {
	servers.POST({
		url: "/analysis/api/school/export_prominent",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.examStudentListFail = function (data, callback) {
	servers.GET({
...
/** 
 * Created by AnalysisMobileSXTApi-findRealQuestionError
 *
 * 查询一个学科所有学生的所有错题（孟加鑫） #2017-05-02#
 *
 * @examId 	考试Id-String
 * @baseCourseId 	云平台科目Id-String
 */
exports.AnalysisMobileSXTApi_findRealQuestionError = function (data, callback) {
	servers.GET({
		url: "/analysis/api/mobile/sxt/find_real_question_error",
		token: data.TOKEN!=undefined?data.TOKEN:"",
		swaggerId: "AnalysisMobileSXTApi-findRealQuestionError",
		query: {
			examId: data.examId,
			baseCourseId: data.baseCourseId
		}
...
/** End AnalysisMobileSXTApi-findRealQuestionError */
 ...
 */
exports.findErrorStudents = function (data, callback) {
	servers.GET({
		url: "/analysis/api/paper/find_error_students/"+data.classId+"/"+data.questionId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.schoolScoreLine = function (data, callback) {
	servers.POST({
		url: "/analysis/api/school/find_score_line",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.listSubjectLeader = function (data, callback) {
	servers.POST({
...
exports.ExamPaperSplitApi_tempSave = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-paper-split/temp_save",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.getAnalysisClassScoreLine = function (data, callback) {
	servers.POST({
		url: "/analysis/api/class/find_class_score_line",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.searchPlatformPoints = function (data, callback) {
	servers.POST({
 ...
 * @examCourseId 	考试科目ID-String * @regionId 	区域ID-String
 */
exports.findRegionPoint = function (data, callback) {
	servers.GET({
		url: "/analysis/api/region-paper/find_region_point/"+data.examCourseId+"/"+data.regionId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.findStudentPointRatio = function (data, callback) {
	servers.POST({
		url: "/analysis/api/student/find_student_point_ratio",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.exportPassRegion = function (data, callback) {
	servers.POST({
 ...
 */
exports.downloaTtemplateTarget = function (data, callback) {
	servers.GET({
 ...
 * @param 	优生统计参数列表-Body
 */
exports.schoolFindProminent = function (data, callback) {
	servers.POST({
		url: "/analysis/api/school/find_prominent",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.exportClassQuestion = function (data, callback) {
	servers.POST({
		url: "/analysis/api/paper/export_class_question",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.saveDeparment = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-class-part/create",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.scoreImportListSuccess = function (data, callback) {
	servers.POST({
 ...
 */
exports.schoolScoreAverage = function (data, callback) {
	servers.POST({
		url: "/analysis/api/school/find_average",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamScoreLineApi_listByExamAndLineType = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-score-line/list/"+data.examId+"/"+data.lineType,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamScoreLineApi_getLineTypeByExam = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-score-line/get_line_type/"+data.examId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 *
 */
exports.getSettingAnalysisTypeData = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-score-line/line_types",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.AnalysisClassApi_exportClassAverage = function (data, callback) {
	servers.POST({
		url: "/analysis/api/class/export_class_average",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.getTheLastExamScoreLineData = function (data, callback) {
	servers.POST({
		url: "/analysis/api/school/find_recent_score_line",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.getAnalysisClassCompare = function (data, callback) {
	servers.POST({
		url: "/analysis/api/class/find_class_compare",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examCourseId 	考试科目ID-String * @regionId 	区域ID-String
 */
exports.exportRegionPoint = function (data, callback) {
	servers.GET({
		url: "/analysis/api/region-paper/export_region_point/"+data.examCourseId+"/"+data.regionId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamPaperSplitApi_validate = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-paper-split/validate",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.exportClassAbility = function (data, callback) {
	servers.POST({
		url: "/analysis/api/paper/export_class_ability",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.AnalysisMobileTouchLineApi_countStudents = function (data, callback) {
	servers.GET({
		url: "/analysis/api/touch-line/count_students/"+data.schoolId+"/"+data.examId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamIndexApi_countBySemester = function (data, callback) {
	servers.GET({
		url: "/exam/api/index/count_semester",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examId 	考试ID-String
 */
exports.getSettingPaperAllCourses = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-paper-split/course_dropdown/"+data.examId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.startCountAchievement = function (data, callback) {
	servers.GET({
 ...
 * @examId 	考试ID-String
 */
exports.queryListClass = function (data, callback) {
	servers.GET({
 ...
 * @param 	查询参数-Body
 */
exports.findByRegion = function (data, callback) {
	servers.POST({
		url: "/analysis/api/touch-line/find_by_region",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examCourseId 	考试科目ID-String * @regionId 	区域ID-String
 */
exports.exportRegionAbility = function (data, callback) {
	servers.GET({
		url: "/analysis/api/region-paper/export_region_ability/"+data.examCourseId+"/"+data.regionId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examCourseId 	考试科目ID-String * @regionId 	区域ID-String
 */
exports.exportRegionQuestion = function (data, callback) {
	servers.GET({
		url: "/analysis/api/region-paper/export_question/"+data.examCourseId+"/"+data.regionId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamScoreLineApi_downloadTemplate = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-score-line/download_template/"+data.examId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
/** 
 * Created by ExamQueryApi-pageForTeacher
 *
 * 查询教师考试列表 (陈显官) #2017-04-28#
 *
 * @queryPageForTeacherDTO 	queryPageForTeacherDTO-Body
 */
exports.ExamQueryApi_pageForTeacher = function (data, callback) {
	servers.POST({
		url: "/exam/api/query/page_for_teacher",
		token: data.TOKEN!=undefined?data.TOKEN:"",
		swaggerId: "ExamQueryApi-pageForTeacher",
		body: data.body,
		query: {
		}
	}, callback);
};
/** End ExamQueryApi-pageForTeacher */
...
exports.AnalysisPaperApi_findSelectionQuestion = function (data, callback) {
	servers.GET({
		url: "/analysis/api/paper/find_selection_question/"+data.schoolId+"/"+data.examCourseId+"/"+data.classId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.findCityGradeId = function (data, callback) {
	servers.GET({
 ...
 * @param 	平均分分析参数列表-Body
 */
exports.exportAverageSchool = function (data, callback) {
	servers.POST({
		url: "/analysis/api/school/export_average",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @param 	分数段分析参数列表-Body
 */
exports.schoolFindSection = function (data, callback) {
	servers.POST({
		url: "/analysis/api/school/find_section",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.findRegionSplitPaper = function (data, callback) {
	servers.POST({
		url: "/analysis/api/region-paper/find_split_paper",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.AnalysisMobileTouchLineApi_findStudents = function (data, callback) {
	servers.POST({
		url: "/analysis/api/mobile/touch-line/find_students",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.exportClassChoiceQuestion = function (data, callback) {
	servers.POST({
		url: "/analysis/api/paper/export_choice_question",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 *
 */
exports.getCurrentUserInfos = function (data, callback) {
	servers.GET({
 ...
 * @type 	计算规则类型-Number
 */
exports.getSettingRuleTypeData = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-calculate-rule/caculate_rule_types/"+data.type,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.findClassAbility = function (data, callback) {
	servers.POST({
		url: "/analysis/api/paper/find_class_ability",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.AnalysisClassApi_exportClassScoreLine = function (data, callback) {
	servers.POST({
		url: "/analysis/api/class/export_class_score_line",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.AnalysisExcellentApi_findStudents = function (data, callback) {
	servers.POST({
		url: "/analysis/api/excellent/find_students",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 *
 */
exports.getCountSemesterExamNumber = function (data, callback) {
	servers.GET({
		url: "/exam/api/index/count_semester_list",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examCourseId 	考试科目ID-String * @regionId 	区域ID-String
 */
exports.findRegionQuestion = function (data, callback) {
	servers.GET({
		url: "/analysis/api/region-paper/find_question/"+data.examCourseId+"/"+data.regionId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examId 	考试Id-String * @studentId 	学生Id-String
 */
exports.findStudentCourseRatio = function (data, callback) {
	servers.GET({
		url: "/analysis/api/student/find_student_course_ratio/"+data.examId+"/"+data.studentId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @phase 	学段-Number
 */
exports.listPhaseGrades = function (data, callback) {
	servers.GET({
 ...
 * @examId 	考试ID-String
 */
exports.validAllQuestionPaperCompleteEdit = function (data, callback) {
	servers.GET({
		url: "/exam/api/question/complete_edit/"+data.examId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.timeFindTerm = function (data, callback) {
	servers.GET({
 ...
 * @tenantId 	租户唯一ID-Number
 */
exports.listPatformTerms = function (data, callback) {
	servers.GET({
...
exports.ExamPaperSplitApi_remove = function (data, callback) {
	servers.DELETE({
		url: "/exam/api/setting-paper-split/remove/"+data.splitId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.examCompares = function (data, callback) {
	servers.POST({
		url: "/analysis/api/exam-compare/find_exam_compare",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @param 	分数线分析参数列表-Body
 */
exports.exportScoreLine = function (data, callback) {
	servers.POST({
		url: "/analysis/api/school/export_score_line",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.AnalysisBrotherSchoolApi_exportAverage = function (data, callback) {
	servers.GET({
		url: "/analysis/api/brother-school/export_average/"+data.examId+"/"+data.schoolId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @param 	学生知识点得分率参数列表-Body
 */
exports.exportStudentPointRatio = function (data, callback) {
	servers.POST({
		url: "/analysis/api/student/export_student_point_ratio",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.exportStudentQuestionRatio = function (data, callback) {
	servers.POST({
		url: "/analysis/api/student/export_student_question_ratio",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examId 	考试ID-String
 */
exports.getExamDetail = function (data, callback) {
	servers.GET({
 ...
 */
exports.getAnalysisInfo = function (data, callback) {
	servers.POST({
 ...
 */
exports.listCountyAndSchools = function (data, callback) {
	servers.GET({
...
exports.ExamHideRatioRuleApi_create = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-ratio-rule/create",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.importExamStudentResult = function (data, callback) {
	servers.GET({
...
exports.ExamClassPartApi_findAll = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-class-part/find_all",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examCourseId 	考试科目ID，网阅考试必需-String
 */
exports.scoreImportErrorHeader = function (data, callback) {
	servers.GET({
 ...
 *
 */
exports.getCurrentExamLevel = function (data, callback) {
	servers.GET({
 ...
 */
exports.modifyExam = function (data, callback) {
	servers.PUT({
...
exports.ExamQuestionApi_findQuestionNums = function (data, callback) {
	servers.GET({
		url: "/exam/api/question/find_question_nums/"+data.courseId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.createExam = function (data, callback) {
	servers.POST({
...
exports.ExamClassLevelApi_find = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-class-level/find/"+data.classLevelId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamQuestionApi_findPoints = function (data, callback) {
	servers.GET({
		url: "/exam/api/question/find_points/"+data.questionId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamScoreLineApi_listByExam_1 = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-score-line/list_score_lines/"+data.examId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.searchOther = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-ratio-rule/find_school_ratio_rule",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.targetSaves = function (data, callback) {
	servers.POST({
 ...
 * @questionDetailList 	双向细目表列表数据-Body * @courseId 	科目ID-String
 */
exports.saveQuestionsByCourseId = function (data, callback) {
	servers.POST({
		url: "/exam/api/question/save/"+data.courseId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examId 	考试mongo-ID-String
 */
exports.downloadStudentTemplate = function (data, callback) {
	servers.GET({
 ...
 * @examCourseId 	考试科目ID，网阅考试必需-String
 */
exports.scoreImportListHeader = function (data, callback) {
	servers.GET({
...
exports.ExamQuestionApi_findLevels = function (data, callback) {
	servers.GET({
		url: "/exam/api/question/find_levels/"+data.questionId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamClassLevelApi_modify = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-class-level/modify",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.consolidationSave = function (data, callback) {
	servers.POST({
 ...
 */
exports.deleteSettingScoreLineById = function (data, callback) {
	servers.DELETE({
		url: "/exam/api/setting-score-line/remove/"+data.scoreLineId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamQuestionApi_importData = function (data, callback) {
	servers.POST({
		url: "/exam/api/question/import_data",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamPaperSplitApi_save = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-paper-split/save",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamQuestionApi_remove = function (data, callback) {
	servers.DELETE({
		url: "/exam/api/question/remove/"+data.questionId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @appId 	子系统ID-String
 */
exports.userGetAppRoleList = function (data, callback) {
	servers.GET({
...
exports.classList = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-class-level/page",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamClassPartApi_modify = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-class-part/modify",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.findClassQuestion = function (data, callback) {
	servers.POST({
		url: "/analysis/api/paper/find_class_question",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.AnalysisBrotherSchoolApi_findExtendStudents = function (data, callback) {
	servers.POST({
		url: "/analysis/api/brother-school/find_valid_extend_students",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.exportRegionSelectionQuestion = function (data, callback) {
	servers.POST({
		url: "/analysis/api/region-paper/export_selection_question",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @param 	人员巩固率分析参数列表-Body
 */
exports.regionFindConsolidation = function (data, callback) {
	servers.POST({
 ...
 * @scoreLineList 	分数线列表数据-Body
 */
exports.saveSettingScoreLIne = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-score-line/save",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.authRefreshToken = function (data, callback) {
	servers.GET({
...
/** 
 * Created by HJg2MES0je
 *
 * 查询所有地区相关学校胡君
 *
 */
exports.HJg2MES0je = function (data, callback) {
	servers.POST({
		url: "/test/list_county_and_schools",
		token: data.TOKEN!=undefined?data.TOKEN:"",
		swaggerId: ""
	}, callback);
};
 ...
 * @examId 	考试ID-String
 */
exports.getEditExamAllCourses = function (data, callback) {
	servers.GET({
		url: "/exam/api/question/course_dropdown/"+data.examId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examId 	考试ID-String * @orgId 	当前学校ID-String * @artCategory 	0：不分科；1：文科；2：理科-Number
 */
exports.setTargetFind = function (data, callback) {
	servers.GET({
...
exports.getCountGradeExamNumber = function (data, callback) {
	servers.GET({
		url: "/exam/api/index/count_grade",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.deleteClass = function (data, callback) {
	servers.DELETE({
		url: "/exam/api/setting-class-level/remove/"+data.classLevelId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examId 	考试ID-String
 */
exports.finishAnalysisSettingChangeExamType = function (data, callback) {
	servers.PUT({
...
exports.AnalysisBrotherSchoolApi_exportExtendStudent = function (data, callback) {
	servers.GET({
		url: "/analysis/api/brother-school/export_extend_students/"+data.examId+"/"+data.schoolId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examId 	考试ID-String
 */
exports.getSettingRuleDataByExamId = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-calculate-rule/list/"+data.examId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 */
exports.scoreSubmitHeader = function (data, callback) {
	servers.POST({
...
exports.ExamQuestionApi_findQuestion = function (data, callback) {
	servers.GET({
		url: "/exam/api/question/find_question/"+data.questionId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.findChoiceQuestionStudents = function (data, callback) {
	servers.POST({
		url: "/analysis/api/paper/find_choice_question_students",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamHideRatioRuleApi_remove = function (data, callback) {
	servers.DELETE({
		url: "/exam/api/setting-ratio-rule/remove/"+data.ratioRuleId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @param 	学生小题得分率参数对象-Body
 */
exports.findStudentQuestionRatio = function (data, callback) {
	servers.POST({
		url: "/analysis/api/student/find_student_question_ratio",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @pageParamDTO 	pageParamDTO-Body
 */
exports.scoreImportListFail = function (data, callback) {
	servers.POST({
 ...
 *
 */
exports.downloadQuestionExcelTemplate = function (data, callback) {
	servers.GET({
		url: "/exam/api/question/download_template",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @params 	参数-Body
 */
exports.findRegionSelectionQuestion = function (data, callback) {
	servers.POST({
		url: "/analysis/api/region-paper/find_selection_question",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamClassPartApi_find = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-class-part/find/"+data.classPartId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.getQuestionsByCourseId = function (data, callback) {
	servers.GET({
		url: "/exam/api/question/find_by_course/"+data.courseId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
/** 
 * Created by SyDJ7Fmsg
 *
 * 根据地区id返回学校列表
 *
 * @orgId 	-
 */
exports.getSchoollsit = function (data, callback) {
	servers.POST({
		url: "/api/v1/organization/schoollsit/",
		token: data.TOKEN!=undefined?data.TOKEN:"",
		swaggerId: "",
		query: {
		}
 ...
 * @param 	查询参数-Body
 */
exports.exportClassSplitPaper = function (data, callback) {
	servers.POST({
		url: "/analysis/api/paper/export_split_paper",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 *
 * @orgId 	当前学校的机构ID-String * @schoolList 	兄弟学校集合-Body
 */
...
exports.ExamCalculateRuleApi_myValidate = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-calculate-rule/validate",
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @examId 	考试ID-String
 */
exports.getExamSettingScoreLine = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-score-line/list/"+data.examId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @param 	查询参数-Body
 */
exports.findSplitPaper = function (data, callback) {
	servers.POST({
		url: "/analysis/api/paper/find_split_paper",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.getRecentExamList = function (data, callback) {
	servers.GET({
		url: "/exam/api/index/list_recent/"+data.count,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @calculateRulesList 	考试计算规则列表数据-Body
 */
exports.saveSettingRule = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-calculate-rule/save",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.removeDepartment = function (data, callback) {
	servers.DELETE({
		url: "/exam/api/setting-class-part/remove/"+data.classPartId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 * @teacherId 	老师ID-Number * @tenantId 	租户ID-Number
 */
exports.listTeacherSubject = function (data, callback) {
	servers.GET({
...
exports.ExamPaperSplitApi_show = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-paper-split/show/"+data.splitId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.ExamScoreLineApi_listHeaders = function (data, callback) {
	servers.GET({
		url: "/exam/api/setting-score-line/list_headers/"+data.examId,
		token: data.TOKEN!=undefined?data.TOKEN:"",
 ...
 *
 */
exports.listPhases = function (data, callback) {
	servers.GET({
...
exports.ExamClassLevelApi_create = function (data, callback) {
	servers.POST({
		url: "/exam/api/setting-class-level/create",
		token: data.TOKEN!=undefined?data.TOKEN:"",
...
exports.getToEditerExamList = function (data, callback) {
	servers.GET({
		url: "/exam/api/index/list_to_edit/"+data.count,
		token: data.TOKEN!=undefined?data.TOKEN:"",
